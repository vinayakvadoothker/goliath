        ...
        <div className="relative min-h-screen w-full overflow-hidden selection:bg-white/20">
            ...
            <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 text-center">
                ...
                <motion.h1
                    ...
                    className="max-w-4xl text-7xl font-bold tracking-tighter md:text-9xl lg:text-[12rem] bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60"
                >
                    Centra
                </motion.h1>
                ...
                <motion.p
                    ...
                    className="mt-6 max-w-2xl text-lg text-gray-400 md:text-2xl font-mono"
                >
